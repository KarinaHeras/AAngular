...
// import { PostsStores } from '../business/post/posts.store';
...
//                 <button *ngIf="action === ''"(click)="onCreate()" [disabled]="!formP\
// ost.valid">Create</button>
//                 <button *ngIf="action === 'update'" (click)="onUpdate()" [disabled]=\
// "!formPost.valid">Update</button>
...
// formPost: FormGroup; action = '';
// constructor(private store: PostsStores){}
// ngOnInit() {
// this.store.init();
...
// }
// onCancel() { this.formPost.get('heading').setValue('');
//              this.formPost.get('content').setValue(''); this.action = '';
// } }
// onCancel(); { this.formPost.get('heading').setValue('');
//              this.formPost.get('content').setValue(''); this.action = '';
// }
